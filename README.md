...
> **Status:** **v0.34.7** — one Flutter (Dart) codebase ships **both** an Android APK and an
...
rules) so it can be unit-tested without a device. **331 Dart tests** plus a widget smoke test (boots the app and opens every
