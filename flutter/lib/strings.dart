...
const Map<String, Map<String, String>> _s = {
  'en': {
    ...
    'shopObjects': 'DECOR',
    'road_asphalt': 'ASPHALT', 'road_wood': 'WOOD PATH', 'road_dirt': 'DIRT PATH', 'road_brick': 'BRICK PATH', 'road_stone': 'STONE PATH',
    'fence_wood': 'WOOD FENCE', 'fence_dark': 'DARK FENCE', 'fence_stone': 'STONE FENCE', 'fence_white': 'WHITE FENCE',
    'garden': 'GARDEN', 'gardenHelp': 'CUSTOMIZE, then tap tiles. Pinch to zoom · drag to pan.',
  ...
  'tr': {
    ...
    'shopObjects': 'SÜS',
    'road_asphalt': 'ASFALT', 'road_wood': 'TAHTA YOL', 'road_dirt': 'TOPRAK YOL', 'road_brick': 'TUĞLA YOL', 'road_stone': 'TAŞ YOL',
    'fence_wood': 'TAHTA ÇİT', 'fence_dark': 'KOYU ÇİT', 'fence_stone': 'TAŞ ÇİT', 'fence_white': 'BEYAZ ÇİT',
    'garden': 'BAHÇE', 'gardenHelp': 'ÖZELLEŞTİR, sonra karelere dokun. Yakınlaştır · sürükle.',
  ...
  'pl': {
    ...
    'road_asphalt': 'ASFALT', 'road_wood': 'DROGA DREW.', 'road_dirt': 'DROGA ZIEM.', 'road_brick': 'DROGA CEGL.', 'road_stone': 'DROGA KAM.',
    'fence_wood': 'PŁOT DREW.', 'fence_dark': 'CIEMNY PŁOT', 'fence_stone': 'PŁOT KAM.', 'fence_white': 'BIAŁY PŁOT',
    'garden': 'OGRÓD', 'gardenHelp': 'DOSTOSUJ, potem dotykaj pól. Szczyp · przeciągnij.',
  ...
  'de': {
    ...
    'shopObjects': 'DEKO',
    'road_asphalt': 'ASPHALT', 'road_wood': 'HOLZWEG', 'road_dirt': 'ERDWEG', 'road_brick': 'ZIEGELWEG', 'road_stone': 'STEINWEG',
    'fence_wood': 'HOLZZAUN', 'fence_dark': 'DUNKLER ZAUN', 'fence_stone': 'STEINZAUN', 'fence_white': 'WEISSER ZAUN',
    'garden': 'GARTEN', 'gardenHelp': 'ANPASSEN, dann Felder tippen. Zoomen · ziehen.',
  ...
  'ko': {
    ...
    'shopObjects': '장식',
    'road_asphalt': '아스팔트', 'road_wood': '나무길', 'road_dirt': '흙길', 'road_brick': '벽돌길', 'road_stone': '돌길',
    'fence_wood': '나무 울타리', 'fence_dark': '진한 울타리', 'fence_stone': '돌 울타리', 'fence_white': '흰 울타리',
    'garden': '정원', 'gardenHelp': '꾸미기 후 타일을 누르세요. 확대 · 이동.',
  ...
  'it': {
    ...
    'shopObjects': 'DECORO',
    'road_asphalt': 'ASFALTO', 'road_wood': 'VIA LEGNO', 'road_dirt': 'VIA TERRA', 'road_brick': 'VIA MATTONI', 'road_stone': 'VIA PIETRA',
    'fence_wood': 'REC. LEGNO', 'fence_dark': 'REC. SCURO', 'fence_stone': 'REC. PIETRA', 'fence_white': 'REC. BIANCO',
    'garden': 'GIARDINO', 'gardenHelp': 'PERSONALIZZA, poi tocca le celle. Pizzica · trascina.',
