...
const Map<String, Map<String, String>> _s = {
  'en': {
    ...
    'purchased': 'PURCHASED', 'shopHelp': '1 coin / 5 focus min · flowers 10 · road & fence 5',
    'shopObjects': 'DECOR', 'road': 'ROAD', 'fence': 'FENCE',
    'garden': 'GARDEN', 'gardenHelp': 'CUSTOMIZE, then tap tiles. Pinch to zoom · drag to pan · slider tilts the view.',
  ...
  'tr': {
    ...
    'shopObjects': 'SÜS', 'road': 'YOL', 'fence': 'ÇİT',
    'garden': 'BAHÇE', 'gardenHelp': 'ÖZELLEŞTİR, sonra karelere dokun. Yakınlaştır · sürükle · kaydırıcı eğer.',
  ...
  'pl': {
    ...
    'shopObjects': 'DEKORACJE', 'road': 'DROGA', 'fence': 'PŁOT',
    'garden': 'OGRÓD', 'gardenHelp': 'DOSTOSUJ, potem dotykaj pól. Szczyp · przeciągnij · suwak pochyla.',
  ...
  'de': {
    ...
    'shopObjects': 'DEKO', 'road': 'STRASSE', 'fence': 'ZAUN',
    'garden': 'GARTEN', 'gardenHelp': 'ANPASSEN, dann Felder tippen. Zoomen · ziehen · Regler neigt.',
  ...
  'ko': {
    ...
    'shopObjects': '장식', 'road': '길', 'fence': '울타리',
    'garden': '정원', 'gardenHelp': '꾸미기 후 타일을 누르세요. 확대 · 이동 · 슬라이더로 기울이기.',
  ...
  'it': {
    ...
    'shopObjects': 'DECORO', 'road': 'STRADA', 'fence': 'RECINTO',
    'garden': 'GIARDINO', 'gardenHelp': 'PERSONALIZZA, poi tocca le celle. Pizzica · trascina · cursore inclina.',
